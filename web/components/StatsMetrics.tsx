...
export function StatsMetrics() {
  ...
  return (
    <section id="architecture" className="relative py-24 md:py-32 bg-neutral-50/60 border-t border-neutral-200/80 text-slate-900">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {pillars.map((pillar) => (
            <div
              key={pillar.num}
              className="rounded-2xl modern-card p-6 space-y-4 flex flex-col justify-between"
            >
              <div>
