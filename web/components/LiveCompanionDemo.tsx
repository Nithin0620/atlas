...
export function LiveCompanionDemo() {
  ...
  return (
    <section id="companion" className="relative py-24 md:py-32 glass-section border-t border-white/50 text-slate-900">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <Reveal delay={120} className="mt-10 flex justify-center">
          <div className="inline-flex p-1.5 rounded-full glass border border-white/50 gap-1 shadow-inner">
            <button
        ...
        <Reveal delay={180} className="mt-8 max-w-4xl mx-auto">
          <div className="rounded-3xl border border-white/60 glass p-6 sm:p-10 shadow-lg">
            {activeTab === 'visual' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-white/30 backdrop-blur-xl border border-white/50 space-y-3">
            ...
            {activeTab === 'debrief' && (
              <div className="space-y-6">
                ...
                <div className="p-5 rounded-2xl bg-white/30 backdrop-blur-xl border border-white/50 space-y-3 text-xs sm:text-sm text-slate-700">
